              ...
              <MDBTable striped>
                  ...
                  <MDBTableBody>
                    ...
                    <tr>
                      ...
                      <td> <FormLabel  style={{ fontSize:2 }} component="legend" className="text-center " style={{ marginRight:200}}>Trabajo horas extras más de tres veces a la semana.</FormLabel></td> 
                    ...
                    <tr>
                      <td> <FormLabel  style={{ fontSize:2 }} component="legend" className="text-center " style={{ marginRight:200}}>Mi trabajo me exige laborar en días de descanso, festivos o fines de semana.</FormLabel></td> 
                    ...
                    <tr>
                      <td> <FormLabel  style={{ fontSize:2 }} component="legend" className="text-center " style={{ marginRight:200}}>Considero que el tiempo en el trabajo es mucho y perjudica mis actividades familiares o personales.</FormLabel></td> 
                    ...
                    <tr>
                      <td> <FormLabel  style={{ fontSize:2 }} component="legend" className="text-center " style={{ marginRight:200}}>Pienso en las actividades familiares o personales cuando estoy en mi trabajo.</FormLabel></td> 
